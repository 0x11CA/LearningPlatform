...
<header id="header">
    ...
    <li><a href="addcourse.php" >Add</a></li>
      ...
      <li><a href="deletecourse.php" class="active">Delete</a></li>
...
<table>
  ...
  while ($row = mysqli_fetch_assoc($res)) {
    ...
    echo "<td><a href='delete.php?id={$row['courses_id']}' onclick=\"return confirm('Are you sure you want to delete this course?');\">Delete</a></td>";
    echo "</tr>";
  }
